...
- [x] Task 1: Add compiled binary build script using `bun build --compile`.
- [x] Task 2: Add e2e smoke tests (help/version, init, single-task dry-run, PRD dry-run).
- [x] Task 3: Add minimal release notes or usage doc (if needed).
